...
type QueryProvider interface {
	...
	QueryPacketAcknowledgements(ctx context.Context, height uint64, channelid, portid string, latestAckPageKey *[]byte) (acknowledgements []*chantypes.PacketState, err error)
